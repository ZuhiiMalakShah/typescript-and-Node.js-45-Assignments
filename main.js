...
var personName = "Zuhii MalakShah";
...
var friendsName = ["Manzoor", "Maryam", "Hafsa", "Khansa"];
...
var friendsName = ["Zuhii", "Ruqayya", "Talha"];
friendsName.forEach(function (friendName) { return console.log("Hello ".concat(friendName, ", How are u?")); });
// //task  13.
...
//Honda motorcycle."
var transportationModes = ["Sports Bike", "Car", "Luxury Car", "Aeroplane"];
...
var guestList = ["Saima", "Ujala", "Farooq", "Siraj"];
guestList.forEach(function (oneGuest) { return console.log("Salam ".concat(oneGuest, ", would like to dinner with me in Ramazan?")); });
// //task  15.
...
guestList.forEach(function (guest) { return console.log("Salam ".concat(guest, ", would you like to aftar with me in Ramazan?")); });
// //task  16.
...
guestList.forEach(function (oneguest) { return console.log("Assalam u Alaikum ".concat(oneguest, ", would you like to aftar with me in Ramazan?")); });
// //task 17.
...
var countriesToVisit = ["China", "Denmark", "Brazil", "Argintina"];
...
var localLanguages = ["Sindhi", "Pushto", "Balochi", "Punjabi"];
// Print the message of List
console.log("List of Local Languages:", 
// Print the values of Array in the form of list
localLanguages.forEach(function (language) { return console.log(language); }));
var itcourse = {
...
// Define  Variables
var zuhiiShah = "zuhiiShah";
var uppercasezuhiiShah = "ZUHIISHAH";
var ten = 10;
var twenty = 20;
...
// Creating a Array
var userNames = ["Manzoor", "Maryam", "Aliya", "Admin", "Doll"];
...
var current_users = ["Talha", "musab", "Waqas", "Zaid", "Haris"];
// Array of New Users
var new_users = ["Khansa", "Ruqayya", "Musab", "Aliya", "Waqas"];
...
// Creating a Array
var petAnimals = ["kitten", "Horse", "chick"];
// Using For-loop
...
var album1 = make_album("ArtistZuhii", "Album title 1");
var album2 = make_album("Zuhii", "Album title 2");
// Calling a make_album function with 3rd parameter
var album3 = make_album("Shah", "Album title 3", 10);
...
var magicians2 = ["doll", "aliya", "haris"];
...
var magicians3 = ["doll", "aliya", "haris"];
//////////////////////////////////////////////////////////////
...
function createCar(manufacturer, model) {
    ...
    var car = new (Car.bind.apply(Car, __spreadArray([void 0, manufacturer, model], args, false)))();
    console.log(car);
    return car;
}
// Example usage:
var myCar = createCar('Toyota', 'Corolla', { color: 'blue' }, { optionalFeature: 'sunroof' });
